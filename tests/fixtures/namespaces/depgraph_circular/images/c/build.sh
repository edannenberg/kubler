...
#     kubler.sh build -i depgraph_namespace/c
...
configure_rootfs_build()
{
    ...
    #init_docs "depgraph_namespace/c"
    :
}
...
finish_rootfs_build()
{
    ...
    #export DISTRIBUTION_DIR="${GOPATH}/src/github.com/depgraph_namespace/c"
    #mkdir -p "${DISTRIBUTION_DIR}"

    #git clone https://github.com/depgraph_namespace/c.git "${DISTRIBUTION_DIR}"
    #cd "${DISTRIBUTION_DIR}"
    #git checkout tags/v${_c_version}
    #echo "building c ${_c_version}.."
    ...
    #log_as_installed "manual install" "c-${_c_version}" "https://c.org/"
