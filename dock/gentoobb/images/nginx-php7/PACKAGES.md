### gentoobb/nginx-php7:20160915
Built: Mon Sep 19 01:39:11 CEST 2016
...
dev-lang/php-7.0.10 | `bcmath berkdb bzip2 calendar cli crypt ctype curl fileinfo filter fpm gd hash iconv json mhash mysql mysqli nls opcache pcntl pdo phar posix readline session simplexml soap sockets ssl threads tokenizer unicode webp xml xmlreader xmlrpc xmlwriter xpm xslt zip zlib -apache2 -cdb -cgi -cjk -debug -embed -enchant -exif (-firebird) -flatfile (-frontbase) -ftp -gdbm -gmp -imap -inifile -intl -iodbc -ipv6 -kerberos -ldap -ldap-sasl -libedit -libressl -mssql -oci8-instant-client -odbc -phpdbg -postgres -qdbm -recode (-selinux) -sharedmem -snmp -spell -sqlite -systemd -sysvipc -tidy -truetype -wddx`
...
dev-php/pecl-apcu-5.1.5 | `lock`
dev-php/pecl-apcu_bc-1.0.3 | ` `
dev-php/pecl-redis-3.0.0 | `(-igbinary)`
dev-php/xdebug-2.4.0 | ` `
dev-php/xdebug-client-2.4.0 | `-libedit`
mail-mta/nullmailer-1.13-r5 | `ssl`
media-gfx/imagemagick-6.9.4.6 | `bzip2 cxx jpeg jpeg2k png tiff webp zlib -`
media-libs/giflib-4.1.6-r3 | `-`
media-libs/lcms-2.6-r1 | `jpeg threads tiff zlib -doc -static-libs {-test}`
media-libs/libjpeg-turbo-1.5.0 | `-java -static-libs`
media-libs/libpng-1.6.21 | `-apng (-neon) -static-libs`
media-libs/libwebp-0.4.0 | `gif jpeg png tiff -experimental -opengl -static-libs -swap-16bit-csp`
media-libs/openjpeg-2.1.0 | `-doc -static-libs {-test}`
media-libs/tiff-4.0.6 | `cxx jpeg zlib -jbig -lzma -static-libs {-test}`
...
www-servers/nginx-1.11.4 | `http http-cache http2 pcre ssl threads -aio -debug -ipv6 -libatomic -luajit -mail -pam -pcre-jit -perftools -rrd (-selinux) -stream -vim-syntax`
