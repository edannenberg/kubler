### kubler/mariadb:20170925

Built: Mon Sep 25 17:22:26 CEST 2017
Image Size: 266MB
...
dev-db/mariadb-10.1.26 | `backup bindist cracklib openssl perl server -debug -embedded -extraengine -galera -innodb-lz4 -innodb-lzo -innodb-snappy -jdbc -jemalloc -kerberos -latin1 (-libressl) (-mroonga) -odbc -oqgraph -pam -profiling (-selinux) -sphinx -sst-rsync -sst-xtrabackup -static -static-libs -systemd -systemtap -tcmalloc {-test} -tokudb -xml -yassl`
