### kubler/nginx-php7:20180326

Built: Mon Mar 26 22:44:11 CEST 2018
Image Size: 111MB
...
media-gfx/imagemagick-7.0.7.19 | `bzip2 cxx jpeg jpeg2k png tiff webp zlib -`
...
www-servers/nginx-1.13.10 | `http http-cache http2 pcre ssl threads -aio -debug -ipv6 -libatomic -libressl -luajit -pcre-jit -rtmp (-selinux) -vim-syntax`
**FROM kubler/openssl** |
