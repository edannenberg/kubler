...
configure_rootfs_build()
{
    ...
    #init_docs "${tmpl_namespace}/${tmpl_image_name}"
    :
}
...
finish_rootfs_build()
{
    ...
    #export DISTRIBUTION_DIR="${GOPATH}/src/github.com/${tmpl_namespace}/${tmpl_image_name}"
    #mkdir -p ${DISTRIBUTION_DIR}

    #git clone https://github.com/${tmpl_namespace}/${tmpl_image_name}.git ${DISTRIBUTION_DIR}
    #cd ${DISTRIBUTION_DIR}
    #git checkout tags/v${${tmpl_image_name}_version}
    #echo "building ${tmpl_image_name} ${${tmpl_image_name}_version}.."
    ...
    #log_as_installed "manual install" "${tmpl_image_name}-${${tmpl_image_name}_version}" "https://${tmpl_image_name}.org/"
    :
}
